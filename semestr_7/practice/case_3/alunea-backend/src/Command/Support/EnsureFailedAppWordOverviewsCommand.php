...
#[AsCommand(name: 'support:app-word-overviews:failed:ensure')]
class EnsureFailedAppWordOverviewsCommand extends Command
{
    ...
    {
        foreach ($this->userWordReferenceService->getFailedUserWordReferencesGenerator() as $userWordReference) {
